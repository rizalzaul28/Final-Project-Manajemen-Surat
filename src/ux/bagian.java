...
public class bagian extends javax.swing.JPanel implements Bagian.PerubahanData {
 ...
 private Bagian bgn;
    ...
    private void initComponents() {
        ...
        b_Tambah.setFont(new java.awt.Font("Segoe UI Semibold", 1, 24)); // NOI18N
        b_Tambah.setForeground(new java.awt.Color(0, 125, 197));
        b_Tambah.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        b_Tambah.setText("Tambah Bagian Surat");
    ...
    private void b_TambahMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_b_TambahMouseClicked
         try {
            PopUpTambahBagian popUp = new PopUpTambahBagian(null, true, bgn);
